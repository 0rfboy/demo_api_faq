...
faker = Faker("en_US")
BASE_URL = "https://api.demo.tn.uz/api/v1/faqs"
HEADERS = {
...
POST_TESTS = [
    (
        ...
        "",
        {
            "question": fake_i18n_word(),
            "answer": fake_i18n_word(),
    ...
    (
        "post_002",
        "additionalPropga true yoki false yuborish",
        "POST",
        "question.en = true",
        {
            "question": {"en": True, "uz": fake_i18n_word()["uz"], "ru": fake_i18n_word()["ru"]},  # неверный тип en
            "answer": fake_i18n_word(),
            "position": faker.random_int(min=1, max=100)
        },
        400
...
"""
    ...
    print("\n" + "=" * 60)
    print("✅ Отчёт успешно создан: faq.html")
    print("=" * 60)
