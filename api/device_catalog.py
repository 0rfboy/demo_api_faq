...
faker = Faker("en_US")
BASE_URL = "https://api.demo.tn.uz/api/v1/device-catalogs"
HEADERS = {
...
POST_TESTS = [
    (
        ...
        "",
        {
            ...
            "description": fake_i18n_word(),
            "image": fake_i18n_word(),
            "isActive": True,
            "position": 0,
            "title": fake_i18n_word()
        },
        201
    ),
    (
